        ...
        <div class="collapse navbar-collapse" id="navbarExpanded">
            <ul class="navbar-nav me-auto mb-2 mb-sm-0">
                <li class="nav-item me-3 active">
                    <a class="nav-link active" aria-current="page"  href="<?= base_url() ?>"><?=lang('Basic.global.Home')?></a>
                </li>
                <li class="nav-item me-3 active">
                    <a class="nav-link" href="https://www.ozar.net/products/codeigniterwizard/sample?r=uap434dmml&layout=1&theme=bs5"><?=lang('Basic.global.About')?></a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <!-- Dark-mode switcher, before the user menu -->
                <li class="nav-item">
            ...
            <?php if (logged_in()) { ?>
                <li class="nav-item dropdown user-menu">
                    ...
                    <div class="dropdown-menu dropdown-menu-dark">
                        <a href="<?= url_to('user-profile') ?>" class="dropdown-item">
            ...
            <?php } else { ?>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-dark dropdown-menu-right">
                        <a href="<?= url_to('login') ?>" class="dropdown-item">
                            <i class="bi bi-box-arrow-in-right"></i> &nbsp;
                            <?= lang('Auth.signIn') ?>
                        </a>
                        <a href="<?= url_to('register') ?>" class="dropdown-item">
