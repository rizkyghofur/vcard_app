...
class Auth extends \Myth\Auth\Config\Auth
{
    ...
    public $viewLayout = 'Themes/Bootstrap5/AdminLayout/authLayout';
    ...
    //--------------------------------------------------------------------
    // Allow User Forgot Password
    //--------------------------------------------------------------------
    // When enabled (default) any forgot user may apply for their
    // account. If you disable forgot you may need to ensure your
    // controllers and views know not to offer forgot password.
    //

    public $allowForgotPassword = false;
